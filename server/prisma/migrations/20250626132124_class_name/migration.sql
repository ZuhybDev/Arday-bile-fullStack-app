...
INSERT INTO "new_Student" ("code", "createdAt", "id", "name", "password", "role", "schoolId", "updatedAt") SELECT "code", "createdAt", "id", "name", "password", "role", "schoolId", "updatedAt" FROM "Student";
DROP TABLE "Student";
